        ...
        <div className="flex w-full">
          <div className=" bg-white rounded-lg p-5 w-3/4">
            ...
            <div class="flex h-20 w-full ">
              <button class="flex items-center ml-12 text-center w-1/2 border-gray-300 border rounded px-4 py-2 m-1 focus:border-primary " onClick={()=>setDelivery(true)}>
                <img src={truck} alt="" class="mr-2" />
                <p class="ml-14 text-gray-700 text-md font-semibold">
                  Delivery
                </p>
              </button>
