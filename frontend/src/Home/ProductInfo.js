...
const ProductInfo = () => {
  ...
  return (
    <div className="">
      ...
      <div className="mt-10">
        <div>
          <p className=" px-20 font-pop font-bold text-xl">Recommended for you </p>
        </div>
        <div>
          <div className="">
            <div
  ...
  <div>
    <p>Copyright © 2023 - All right reserved by<span className="text-primary font-pop font-bold text-lg ml-1"> HomeLift</span> </p>
  </div>
</footer>
    </div>
  );
