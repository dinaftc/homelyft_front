    ...
    <div className="bg-white">
      ...
      <div className="w-full">
        <Element name="section1" className="relative">
          <img src={homePic} className="w-full h-auto" alt="Home" />
          <div className="absolute inset-0 flex flex-col justify-start ml-10 mt-20 space-y-4 animate-fadeIn animate-translateY">
            <div className="font-pop text-white text-5xl font-bold">
              <h1>Make Your Interior</h1>
              <h1>More Modern</h1>
            </div>
            <div className="text-white font-pop text-2xl font-normal">
              <p>Turn your room with HomeLift into a lot</p>
              <p>More modern one</p>
            </div>
          </div>
        </Element>
        <Element className="py-10">
          ...
          <div className="mt-5">
            <div className="flex justify-center text-gray-400 font-pop animate-fadeIn1 animate-translateY1">
              <p>
                <span className="ml-3">
                  We will always offer and provide the best collections
                </span>{" "}
                <br />
                for furniture and interiors needs at home and anywhere{" "}
                <br />
                <span className="flex justify-center">at affordable prices</span>
              </p>
            </div>
            <div className="flex justify-end">
              <img src={Rect2} alt="Rectangle" />
            </div>
          </div>
        </Element>
        <div className="flex flex-row mt-5 py-10 px-5 mx-10 justify-between">
          <div className="relative">
            <img src={Rect32} alt="Rectangle32" />
            <div className="absolute inset-0 flex flex-col items-center justify-center opacity-0 hover:opacity-100 transition-opacity bg-gray-900 bg-opacity-75">
              <p className="text-white text-xl font-pop">Check our Categories!</p>
              <Link
                to="/Home"
          ...
          <div className="relative">
            <img src={Rect31} alt="Rectangle31" className="w-full h-auto" />
          ...
          <div className="relative">
            <img src={Rect33} alt="Rectangle33" />
            <div className="absolute inset-0 flex flex-col items-center justify-center opacity-0 hover:opacity-100 transition-opacity bg-gray-900 bg-opacity-75">
              <p className="text-white text-xl font-pop">Check our Products!</p>
              <Link
                to="/Home"
                className="mt-10 font-pop text-base btn normal-case text-white rounded-full bg-primary border-primary"
              >
        ...
        <div className="bg-gray-200 py-12 px-10 space-x-24 flex flex-row">
          <div>
          ...
          <div>
            <p className="text-black font-pop text-xl font-semibold">About</p>
          ...
          <div>
            <p className="text-black font-pop text-xl font-semibold">Services</p>
            <div className="text-gray-500 font-pop text-sm mt-3 space-y-2">
              <p>Delivery</p>
          ...
          <div>
            ...
            <div className="flex flex-row justify-center cursor-pointer">
              <a
                href="https://www.facebook.com/yassine.gzn/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/yvcine.guezz/ "
                target="_blank"
                rel="noopener noreferrer"
              >
                <Lottie
              ...
              <a
                href="https://twitter.com/TGuezzen "
                target="_blank"
                rel="noopener noreferrer"
              >
                <Lottie
            ...
            <p className="font-pop text-gray-500 text-sm flex justify-center mt-10">
              <span className="text-primary font-bold mr-1">HomeLift</span> |
              All Rights Reserved
            </p>
          </div>
        </div>
