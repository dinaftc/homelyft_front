  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center ">
        ...
        <form className=" rounded-lg py-4 px-12" onSubmit={(e) => onSubmit(e)}>
          <div className="my-2">
            <h1
              className="text-3xl font-bold font-pop text-center text-primary "
              onDoubleClick={(e) => {
                e.preventDefault();
              }}
            ...
            <div className="my-1 flex flex-col text-center px-2 mb-7">
              <p
                className="text-gray-400 font-pop font-normal font-400 "
                onDoubleClick={(e) => {
                  e.preventDefault();
                }}
                style={{ userSelect: "none" }}
          ...
          <div className="InputBox">
            <input onChange={handleEmailChange} value={email} required />
            <span
              onDoubleClick={(e) => {
                e.preventDefault();
              }}
          ...
          <div className="my-7">
            ...
            <div className="flex flex-row justify-center">
              <div className="my-1 text-center ">
                <p
                  className="text-sm inline-block text-gray-500 font-pop font-normal font-400"
                  onDoubleClick={(e) => {
                    e.preventDefault();
                  }}
                  style={{ userSelect: "none" }}
