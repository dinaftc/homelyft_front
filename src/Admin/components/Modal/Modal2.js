...
const Modal2 = () => {
  ...
  return (
    <div className="flex justify-center items-center overflow-x-hidden overflow-y-auto  h-screen   ">
      <div className="bg-white rounded-lg p-5 w-1/3">
        ...
        <div className="flex flex-row  mt-5 justify-end gap-3">
          <div>
            <button className="font-pop btn btn-outline normal-case bg-gray-300 text-black hover:bg-gray-200 rounded-full border-transparent hover:border-transparent hover:text-black">
              Cancel
            </button>
          </div>
          <div>
