...
">Staff</p>
  ...
  <div className="dropdown dropdown-top ml-auto">
    <label tabIndex={0} className="btn bg-green-200  rounded-full text-primary outline-none border-none m-1">Manage</label>
    <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
      <button>Contact</button>
      <button onClick={() => handleDesactivate(member.id,member.blocked)}>{member.blocked? 'Acivate' :'Desactivate'}</button>
